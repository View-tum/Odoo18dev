...
class ServiceAcceptanceLine(models.Model):
    ...
    price_unit = fields.Float(
        string='Unit Price', related='po_line_id.price_unit', store=True, readonly=True)
    amount = fields.Float(
    ...
    @api.depends('qty_accepted', 'price_unit')
    def _compute_amount(self):
        for line in self:
            line.amount = line.qty_accepted * line.price_unit
