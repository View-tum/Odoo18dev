{
    ...
    'description': """
Partner and product approval controls for Sales and Accounting.

- Enforces approval on customers for Sales Orders and Invoices.
- Enforces approval on products used in Sales Orders.
- Allows exemptions for e-commerce customers and website orders.
""",
    'version': '18.0.1.0.0',
