...
class AccountTaxReportAbstractWizard(models.AbstractModel):
    ...
    #2026-02-18 add new field SO Type for filter invoice tax type
    so_type_id = fields.Many2one(
        comodel_name="sale.sequence.type",
        required=False,
        string="Tax Invoice Type",
    )
    #2026-02-18 add new field SO Type for filter invoice tax type end
