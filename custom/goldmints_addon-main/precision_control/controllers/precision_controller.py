...
class PrecisionController(http.Controller):
    ...
    def get_precision_settings(self):
        ...
        return {
            ...
            'expense': int(ICP.get_param('precision_control.precision_expense', 2)),
            'stock': int(ICP.get_param('precision_control.precision_stock', 2)),
            'product': int(ICP.get_param('precision_control.precision_product', 2)),
        }
