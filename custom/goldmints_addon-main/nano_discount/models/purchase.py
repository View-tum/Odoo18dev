...
class PurchaseOrderLine(models.Model):
    ...
    total_before_discount_line = fields.Float('ราคาก่อนหักส่วนลด', compute='_compute_total_before_discount_line',
    ...
    def _prepare_account_move_line(self, move=False):
        ...
        res['discount_per_unit'] = self.discount_per_unit
        res['discount_total'] = self.discount_total
        res['total_before_discount_line'] = self.total_before_discount_line
        return res
