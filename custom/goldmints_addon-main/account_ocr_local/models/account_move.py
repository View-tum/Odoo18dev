...
import requests
try:
    from PyPDF2.errors import PyPdfError as PdfCompatibilityError
except ImportError:
    try:
        from PyPDF2.utils import PdfReadError as PdfCompatibilityError
    except ImportError:
        PdfCompatibilityError = Exception
...
class AccountMove(models.Model):
    ...
    def _extend_with_attachments(self, attachments, new=False):
        ...
        except PdfCompatibilityError as error:
