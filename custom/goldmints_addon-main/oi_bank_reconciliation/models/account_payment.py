...
class AccountPayment(models.Model):
    ...
    def _search_statement_matched_payment_id(self, operator, value):
        ...
        domain = [('journal_id','=', line_id.journal_id.id), ('is_matched','=', False), ('state','=', 'in_process'),('move_id','!=', False), line_id.amount > 0 and ('payment_type','=', 'inbound') or ('payment_type','=', 'outbound') ]
