...
class SaleOrder(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        #2026-02-18 add code for differentiate domestic journal full & abbr
        else:
            if not self.so_type_id.is_full_tax_invoice:
                company = self.company_id or self.env.company
                if company.short_journal_id:
                    vals['journal_id'] = company.short_journal_id.id
        #2026-02-18 add code for differentiate domestic journal full & abbr end
