...
class ResCompany(models.Model):
    ...
    sh_customer_statement_auto_send = fields.Boolean("Customer Statement Auto Send")
    ...
    sh_cust_create_log_history = fields.Boolean("Customer Statement Mail Log History")
