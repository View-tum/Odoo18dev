$(document).ready(function (e) {
    ...
    $('#sh_start_date').on("change",function(){
        let selected_start_date = $('#sh_start_date').val();
        let selected_end_date = $('#sh_end_date').val();
    ...
    $('#sh_vendor_start_date').on("change",function(){
        let vendor_selected_start_date = $('#sh_vendor_start_date').val();
        let vendor_selected_end_date = $('#sh_vendor_end_date').val();
