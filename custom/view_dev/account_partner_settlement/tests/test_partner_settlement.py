...
class TestPartnerSettlement(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.bank_journal.outbound_payment_method_line_ids.payment_account_id = (
            cls.env.ref("account.1_account_journal_payment_credit_account_id").id
        )
        cls.bank_journal.inbound_payment_method_line_ids.payment_account_id = (
            cls.env.ref("account.1_account_journal_payment_debit_account_id").id
        )
    ...
    def _create_settlement_wizard(self, move):
        ...
        return self.env["account.payment.register"].with_context(**ctx).create({})
    ...
    def test_payment_register_cross_settlement_supports_wht(self):
        ...
        self.assertAlmostEqual(wizard.payment_difference, 3.0)
