...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_amount(self):
        ...
        for wizard in self:
            ...
            if preserved_state:
                ...
                if not wizard._should_preserve_manual_cross_amount():
    ...
    def _compute_payment_difference(self):
        ...
        for wizard in self:
            ...
            if is_manual_cross_amount:
                manual_deduction_lines = wizard._get_effective_deduction_lines().filtered(
    ...
    def action_create_payments(self):
        ...
        if not self._should_preserve_manual_cross_amount():
