...
class TestPartnerSettlement(TransactionCase):
    ...
    def test_payment_register_view_merges_credit_notes_into_cross_settlement_panel(self):
        ...
        self.assertIn('name="same_side_credit_note_line_ids"', arch)
        self.assertIn('name="cross_settlement_line_ids"', arch)
        self.assertLess(
            arch.index('name="same_side_credit_note_line_ids"'),
            arch.index('name="cross_settlement_line_ids"'),
        )
