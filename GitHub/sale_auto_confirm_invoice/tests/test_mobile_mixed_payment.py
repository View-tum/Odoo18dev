...
class TestMobileMixedPayment(TransactionCase):
    ...
    def test_sale_order_mobile_payment_wizard_can_apply_credit_note_with_cheque(self):
        wizard = self._new_wizard(
            9750.0, [{"payment_type": "bank", "amount": 9750.0}]
        )
        ...
        self.assertEqual(payment.payment_method_line_id, self.cheque_method_line)
        self.assertEqual(payment.inbound_cheque_lines.cheque_id, "CHQ-CN-2500")
