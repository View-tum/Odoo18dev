...
class AccountBankStatementLine(models.Model):
    ...
    def action_reconcile(self): 
        ...
        for account_id, grouped_lines in groupby(sorted((reconcile_lines + other_lines), key=attrgetter('account_id')), key=attrgetter('account_id')):
         grouped_lines = self.env['account.move.line'].concat(*grouped_lines)  
         if account_id.reconcile:
          grouped_lines.reconcile()
