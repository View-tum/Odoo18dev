...
class SaleOrders(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        vals['discount_total_line'] = self.discount_total_line
        vals['total_after_discount'] = self.total_after_discount
        vals['end_discount'] = self.end_discount
        return vals
...
class SaleOrdersLine(models.Model):
        ...
        for line in self:
            if (line.discount_type == 'percentage'
                ...
                line.discount = line.discount_value
                  ...
                  and line.product_uom_qty * line.price_unit != 0
                  and line.product_id.product_tmpl_id.discount == False):
                line.discount = (line.discount_value * 100) / (line.product_uom_qty * line.price_unit)
            elif (line.discount_type == 'amount_per_unit'
                  and line.product_uom_qty * line.price_unit != 0
                  and line.product_id.product_tmpl_id.discount == False):
                line.discount = (line.discount_value * line.product_uom_qty * 100) / (
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        invoice_line['discount_type'] = self.discount_type
        invoice_line['discount_value'] = self.discount_value
        invoice_line['discount_per_unit'] = self.discount_per_unit
        invoice_line['discount_total'] = self.discount_total
        invoice_line['total_before_discount_line'] = self.total_before_discount_line
        return invoice_line
