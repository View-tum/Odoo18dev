...
(async () => {
  ...
  await page.goto(`${base}/web#action=mrp_parallel_console.mrp_parallel_console_action_root`, { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(10000);
  const text = await page.locator('body').innerText();
  await page.screenshot({ path: 'output/playwright/shopfloor-debug.png', fullPage: true });
